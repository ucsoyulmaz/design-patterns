...
<%
	...
	%>
<form action="IngredientInsertButton" method="post" style="border:1px solid #ccc">
  <div class="">
  	<div>
	  		<a href="index.jsp" class="button">Home</a>
	  </div>
    <h1>Ingredient Selection</h1>
    <p>Please select recipe ingredients from the list below.</p>
    <hr>
  </div>
  <div>
  	Recipe ID : 
  	<input type="number" name="recipeIdInserted" value="${recipeIdInserted}" readonly> 
  </div>
